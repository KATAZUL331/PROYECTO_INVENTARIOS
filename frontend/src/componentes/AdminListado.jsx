...
function BusquedaUsuario() {
    ...
    const actualizar = async (e) => {
        ...
        "/usuario/actualizarDatoUsuario/" + id,
        usuario,
        {
            headers: { autorizar: token },
        }
    ...
    const data = usuario.map((usuario) => ({
        id: usuario._id,
                    ...
                    <div className="card-body">
                        ...
                        <div className="row">
                            ...
                            <select
                                ...
                                onChange={(e) => setCargoSelect(e.target.value)}
                                value={cargoSelect}
                            >
                                {cargo.map((cargo) => (
                            ...
                            <select
                                className="form-control"
                                onChange={(e) =>
                                setTipoContratoSelect(e.target.value)
                                }
                                value={tipoContratoSelect}
                            >
                                {tipoContrato.map((tipoContrato) => (
                                <option key={tipoContrato}>{tipoContrato}</option>
                                ))}
                            </select>
                            </div>
